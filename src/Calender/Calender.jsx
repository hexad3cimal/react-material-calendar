...
const Calender= (props) => {
 ...
 const nextMonth = () => {
    const currentYear = (calenderProps.month === 11) ? calenderProps.year + 1 : calenderProps.year;
  ...
  const previousMonth = () => {
    const currentYear = (calenderProps.month === 0) ? calenderProps.year - 1 : calenderProps.year;
    const currentMonth = (calenderProps.month === 0) ? 11 : calenderProps.month - 1;
    setProps({
      ...calenderProps,
      month: currentMonth,
      year: currentYear
        ...
        <CardContent>
          <TableContainer component={Paper}>
            <Table className={classes.table} aria-label="calender">
              <TableBody>
                <Month month={calenderProps.month} year={calenderProps.year} setDates={setDates}
                  selectedDays={calenderProps.selectedDays[calenderProps.year + '-' + (parseInt(calenderProps.month) + 1)]} />
              </TableBody>
            </Table>
          </TableContainer>
